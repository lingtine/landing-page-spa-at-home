          ...
          <div>
            ...
            <div className="space-y-3 text-text-muted">
              ...
              >
                ...
                <span>{translations.footer.zalo}: {translations.footer.phone}</span>
              </button>
              <a
                href={HOTLINE_LINK}
                className="flex items-center gap-2 hover:text-white transition-colors"
              >
                ...
                <span>{translations.footer.hotline}: {translations.footer.phone}</span>
              </a>
              <a
              ...
              >
                ...
                <span>{translations.footer.emailLabel}: {translations.footer.email}</span>
              </a>
            </div>
          </div>
